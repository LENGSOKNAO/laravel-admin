                                ...
                                <div class="w-[70%]">
                                    ...
                                    <div class="flex gap-3 mt-6">
                                        ...
                                        <div class="w-full">
                                            ...
                                            <div id="image-preview-1" class="flex flex-wrap gap-4 mb-4">
                                        ...
                                        <div class="w-full">
                                            ...
                                            <div id="image-preview-2" class="flex flex-wrap gap-4 mb-4">
                                                @if($product->product_list_image)
                                                    @if(is_iterable($product->product_list_image))
                                                        ...
                                                        @endforeach
                                                    @else
                                                        <p class="text-gray-500">Additional images data is not in expected format</p>
                                                    @endif
                                                @else
                                            ...
                                            <div class="w-full p-6 border-2 border-dotted border-gray-300 rounded-lg bg-white flex flex-col items-center justify-center">
                                                <div class="text-gray-500 mb-2">
                                                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width   stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                                    </svg>
                                                </div>
                                                <p class="text-sm text-gray-600">
                                                    Drag your photo here or
                                ...
                                <div class="w-[30%]">
                                    <div class="mt-6 p-7 rounded-[5px] bg-[#fff]">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="relative">
                                                <div id="selectedOptions1" class="border border-gray-300 rounded-lg p-2 min-h-[40px] flex flex-wrap gap-2 cursor-pointer bg-white">
                                                    @if($product->product_category)
                                                        @if(is_iterable($product->product_category))
                                                            @foreach($product->product_category as $category)
                                                                <span class="bg-gray-200 px-2 py-1 rounded">{{ $category }}</span>
                                                            @endforeach
                                                        @else
                                                            <p class="text-gray-500">Categories data is not in expected format</p>
                                                        @endif
                                                    @else
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="relative">
                                                <div id="selectedOptions2" class="border border-gray-300 rounded-lg p-2 min-h-[40px] flex flex-wrap gap-2 cursor-pointer bg-white">
                                                    @if($product->product_sizes)
                                                        @if(is_iterable($product->product_sizes))
                                                            @foreach($product->product_sizes as $size)
                                                                <span class="bg-gray-200 px-2 py-1 rounded">{{ $size }}</span>
                                                            @endforeach
                                                        @else
                                                            <p class="text-gray-500">Sizes data is not in expected format</p>
                                                        @endif
                                                    @else
                                                        <p class="text-gray-500">No sizes selected</p>
                                                    @endif
                                                </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            >
                                                ...
                                                <option value="Newbalance" {{ $product->product_brand == 'Newbalance' ? 'selected' : '' }}>NewBalance</option>
                                    ...
                                    <div class="mt-6 p-7 rounded-[5px] bg-[#fff]">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select name="product_is_enable" class="w-full p-2 text-sm border border-gray-300 rounded-lg bg-white outline-none focus:shadow-[0px_0px_10px_rgb(56,116,255)]">
                                                <option value="1" {{ $product->product_is_enable ? 'selected' : '' }}>True</option>
                                                <option value="0" {{ !$product->product_is_enable ? 'selected' : '' }}>False</option>
                                            </select>
                                        </div>                                                          
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select name="product_comming_soon" class="w-full p-2 text-sm border border-gray-300 rounded-lg bg-white outline-none focus:shadow-[0px_0px_10px_rgb(56,116,255)]">
                                                <option value="0" {{ !$product->product_comming_soon ? 'selected' : '' }}>False</option>
                                                <option value="1" {{ $product->product_comming_soon ? 'selected' : '' }}>True</option>
                                            </select>
                                        </div>  
                    
                                        <div class="mt-4 border-1 border-gray-300 py-2 rounded-[5px] hover:bg-gray-200 bg-gray-100 text-center">
                                            <button class="text-blue-600 text-sm" type="submit">Update product</button>
                                        </div>                                                        
                                    </div>
                                </div>
                            </div>
